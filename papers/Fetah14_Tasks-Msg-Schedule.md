...
- In the simulation, the scheduling overhead is not studied. It would be better to analyze the overhead, otherwise, maybe the execution of the proposed approach itself is time consuming and maybe a simpler scheme will be energy beneficial.
