...
### Weakness
- In the formulation of the GEERP problem in page 7, it seems it lacks one constraint of &Gamma;<sub>m</sub>, i.e., there is no constraint saying that each replicas of &gamma;<sub>i</sub> should be assigned to a core.
