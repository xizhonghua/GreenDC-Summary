...
### Problem
- People outside CS may misunderstood.
  - e.g., a CS guy with even no journal papers but many conference papers could be in professor position.
- Unable for bibliometric evaluation
  - bibliometric is use to evaluate researchers.
  - bibliometric is done using the standard journal database, thus cs conference paper are invisible.
...
- CS conference
  ...
  - alternative approach: conference recommends paper to jorunal
